...
@external(javascript, "../../ffi.mjs", "all_promises")
pub fn await3(a: Promise(a), b: Promise(b), c: Promise(c)) -> Promise(
  #(a, b, c),
)

@external(javascript, "../../ffi.mjs", "all_promises")
pub fn await4(a: Promise(a), b: Promise(b), c: Promise(c), d: Promise(d)) -> Promise(
  #(a, b, c, d),
)

@external(javascript, "../../ffi.mjs", "all_promises")
pub fn await5(a: Promise(a), b: Promise(b), c: Promise(c), d: Promise(d), e: Promise(
    e,
  )) -> Promise(#(a, b, c, d, e))

@external(javascript, "../../ffi.mjs", "all_promises")
pub fn await6(a: Promise(a), b: Promise(b), c: Promise(c), d: Promise(d), e: Promise(
    e,
  ), f: Promise(f)) -> Promise(#(a, b, c, d, e, f))
